...
def Z3_fixedpoint_query_from_lvl(a0, a1, a2, a3):
  r = lib().Z3_fixedpoint_query_from_lvl(a0, a1, a2, a3)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg_ex(a0, err))
  return r
...
def Z3_fixedpoint_get_ground_sat_answer(a0, a1):
  r = lib().Z3_fixedpoint_get_ground_sat_answer(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg_ex(a0, err))
  return r

def Z3_fixedpoint_get_rules_along_trace(a0, a1):
  r = lib().Z3_fixedpoint_get_rules_along_trace(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg_ex(a0, err))
  return r

def Z3_fixedpoint_get_rule_names_along_trace(a0, a1):
  r = lib().Z3_fixedpoint_get_rule_names_along_trace(a0, a1)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg_ex(a0, err))
  return r
...
def Z3_set_logic(a0, a1):
  lib().Z3_set_logic(a0, _to_ascii(a1))
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg_ex(a0, err))
...
def Z3_qe_model_project(a0, a1, a2, a3, a4):
  r = lib().Z3_qe_model_project(a0, a1, a2, a3, a4)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg_ex(a0, err))
  return r

def Z3_qe_model_project_skolem(a0, a1, a2, a3, a4, a5):
  r = lib().Z3_qe_model_project_skolem(a0, a1, a2, a3, a4, a5)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg_ex(a0, err))
  return r

def Z3_model_extrapolate(a0, a1, a2):
  r = lib().Z3_model_extrapolate(a0, a1, a2)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg_ex(a0, err))
  return r

def Z3_qe_lite(a0, a1, a2):
  r = lib().Z3_qe_lite(a0, a1, a2)
  err = lib().Z3_get_error_code(a0)
  if err != Z3_OK:
    raise Z3Exception(lib().Z3_get_error_msg_ex(a0, err))
  return r
